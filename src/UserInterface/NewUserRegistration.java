...
public class NewUserRegistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnl_second.setBackground(new java.awt.Color(0, 153, 255));
        ...
        combo_userLevel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Administrator", "normal user" }));
        ...
        btn_close.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255)));
        ...
        pnl_third.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 80, 30));
        ...
        pnl_third.add(btn_save, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 70, 30));
        ...
        pnl_third.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, 70, 30));

        pnl_second.add(pnl_third, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 340, 230));

        pnl_main.add(pnl_second, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 350, 240));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("NEW USER REGISTRATION");
        pnl_main.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));
        ...
        if (isValidForm()) {
            ...
            if (pass.equals(confirmPass)) {   //in here it checks whether the enetered passwords in two fields are match each other or not
                if (isMatchWithPasswordPolicy(pass)) {  //in here it checks whether the entered password is match with the password policy or not
                    String reversedPass=reverseuser_pass(pass);
                    LoginInfo l = new LoginInfo(txt_userName.getText(),reversedPass, combo_userLevel.getSelectedItem().toString());
